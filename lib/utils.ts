...
export function getElementClassName(elementName: string) {
  switch (elementName) {
    ...
    case "select":
      return "h-12 w-full rounded-md border border-slate-200 bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100";
    case 'error':
